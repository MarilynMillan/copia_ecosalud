...
class HREmployeeLoan(models.Model):
    ...
    def paid_loan(self):
        ...
        if acc_move_id:
            ...
            if self.employee_id.address_id and self.employee_id.address_id.property_account_payable_id:
                credit_account = self.employee_id.address_id.property_account_payable_id.id or False
