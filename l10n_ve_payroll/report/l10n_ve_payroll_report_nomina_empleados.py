        ...
        if payslip_line_ids:
            ...
            for d in departamentos:
                ...
                columns_departamento = [{'name': '', 'class': 'text'},
                                        ...
                                        {'name': '', 'class': 'text'},
                                        {'name': '', 'class': 'text'},
                                        {'name': self.format_value(sum(asignacion), currency=currency_company, blank_if_zero=True, figure_type='monetary'), 'class': 'numeric text-end'},
                                        {'name': self.format_value(sum(deduccion), currency=currency_company, blank_if_zero=True, figure_type='monetary'), 'class': 'numeric text-end'},
                                        {'name': self.format_value(sum(otros), currency=currency_company, blank_if_zero=True, figure_type='monetary'), 'class': 'numeric text-end'},
                                        {'name': self.format_value(sum(total), currency=currency_company, blank_if_zero=True, figure_type='monetary'), 'class': 'numeric text-end'}]
