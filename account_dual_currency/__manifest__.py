# -*- coding: utf-8 -*-
{
    ...
    'depends': [
                ...
                'account_reports_cash_basis', 'account_asset','product','crm','crm_enterprise','account_budget','stock_accountant','purchase_stock'
                ],
    'data':[
        ...
        'data/decimal_precision_extra.xml',
        'data/cron.xml',
        'data/channel.xml',
        ...
        'wizard/account_wh_igtf_list.xml',
        'report/account_wh_igtf_list.xml',
        'views/bank_rec_widget_views.xml',
        "views/account_batch_payment.xml",
        'data/account_dual_currency_report.xml',
